      ...
      <Box className="pill-box">
        <Tooltip label="Patient Name" aria-label="Patient Name Tooltip">
          <Flex alignItems="center" flexBasis="25%">
            <FaUser style={{ marginRight: "8px" }} className="pill-box-icons" />
            <Input
              placeholder="Name"
              size="sm"
              value={patient.name || ""}
        ...
        <Tooltip label="Date of Birth" aria-label="Date of Birth Tooltip">
          <Flex alignItems="center" flexBasis="25%">
            <FaBirthdayCake
              style={{ marginRight: "8px", marginLeft: "8px" }}
              className="pill-box-icons"
        ...
        <Tooltip label="UR Number" aria-label="UR Number Tooltip">
          <Flex alignItems="center" flexBasis="25%">
            ...
            <Input
              ...
              onChange={(e) => handleChange("ur_number", e.target.value)}
              className="input-style"
              borderRightRadius="0"
            />
            <IconButton
